    ...
    <AppBar position="static" sx={{ bgcolor: "transparent" }}>
      <Toolbar sx={{ p: 2 }}>
        ...
        <Box display={{ xs: "none", lg: "flex", alignItems: "center" }} gap={{ lg: 3, xl: 5 }} mr={5}>
          <HeaderButton buttonText="Trang Chủ" buttonLink="/" isActivePage={activePage === "landing"} />
          <HeaderButton buttonText="Tìm sách" buttonLink="/findbooks" isActivePage={activePage === "findbooks"} />
          <HeaderButton buttonText="Góc nhìn mới" buttonLink="/articles" isActivePage={activePage === "articles"} />
